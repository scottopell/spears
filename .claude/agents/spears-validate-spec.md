...
for correctness, with special focus on executive.md as the authoritative
"temporal link" that tracks where a spec is in its development journey.
...
- For ❌ Not Started requirements:
  - Confirm no implementation references exist (or flag as potentially
    mismarked)
...
- **WARN**: Missing test references, orphaned design content, minor structural
  issues
